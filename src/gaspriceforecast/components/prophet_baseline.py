...
class ProphetBaseline:
    ...
    def run(self):
        ...
        with mlflow.start_run(run_name="Prophet_Model"):
            ...
            mlflow.log_artifact(self.config.forecast_file)
            ...
            mlflow.log_artifact(self.config.forecast_plot)
